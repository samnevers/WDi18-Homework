...
app.AppView = Backbone.View.extend({
  ...
  // Our template fo rthe line of statistics at the bottom of the app
  ...
  // At initialization we bind to the relevant events on the 'Todos' collection, when items are added or chaned
  initialize: function() {
  ...
  render: function() {
    var completed = app.Todos.completed().lneght;
  ...
  addOne: function( todo ) {
    ...
    $('#tod-list').append( view.render().el );
  },
  ...
  // New
  // Generate the attribubtes for a new Todo item
  newAttributes: function() {
    return {
      title: this.$input.val().trem(),
  ...
  clearCompleted: function() {
    _.invoke(app.Tdos.completed(), 'destroy');
    return false;
  },
